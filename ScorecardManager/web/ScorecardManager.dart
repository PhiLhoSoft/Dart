...
class ScorecardManager extends PolymerElement
{
	...
	ScorecardManager.created() : super.created()
	{
		...
		Scorecard sc1 = new Scorecard(kpiName: 'One calculation', displayValues: true, iconRanges: [ ic1, ic2, ic3 ]);
		Scorecard sc2 = new Scorecard(kpiName: 'One counter', iconRanges: [ic2]);
		Scorecard sc3 = new Scorecard(kpiName: 'A formula', displayValues: true, iconRanges: [ ic1, ic3 ]);
